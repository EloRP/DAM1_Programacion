...
public class Buscaminas {
        ...
        if (tableroJuego[f][c] == '-') {
            if (tableroMinas[f][c]) {
                ...
                if (minasAdyacentes == 0) {
                    ...
                    if (f > 0)
                        destaparCasilla(f - 1, c);
                    if (f > 0 && c < (COLUMNAS - 1))
                        destaparCasilla(f - 1, c + 1);
                    if (c > 0)
                        destaparCasilla(f, c - 1);
                    if (c < (COLUMNAS - 1))
                        destaparCasilla(f, c + 1);
                    if (f < (FILAS - 1) && c > 0)
                        destaparCasilla(f + 1, c - 1);
    ...
    static int minasAdyacentes(int f, int c) {
        ...
        if (f > 0 && c > 0 && tableroMinas[f - 1][c - 1])
            numMinas++;
        if (f > 0 && tableroMinas[f - 1][c])
            numMinas++;
        if (f > 0 && c < (COLUMNAS - 1) && tableroMinas[f - 1][c + 1])
            numMinas++;

        if (c > 0 && tableroMinas[f][c - 1])
            numMinas++;
        if (c < (COLUMNAS - 1) && tableroMinas[f][c + 1])
            numMinas++;

        if (f < (FILAS - 1) && c > 0 && tableroMinas[f + 1][c - 1])
            numMinas++;
        if (f < (FILAS - 1) && tableroMinas[f + 1][c])
            numMinas++;
        if (f < (FILAS - 1) && c < (COLUMNAS - 1) && tableroMinas[f + 1][c + 1])
            numMinas++;
