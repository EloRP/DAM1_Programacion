...
public class Personaje implements Comparable {
     ...
     * @return Daño hecho.
     */
    public int atacar(Monstruo monstruo) {
        int ataque = ataque + random(1, 100);
        int defensa = monstruo.defensa + random(1, 100);
        ...
        if (danho < 0)
            ...
            if (danho > monstruo.puntosVida) {
                danho = monstruo.puntosVida;
            }
            sumarExperiencia(danho);
            monstruo.perderVida(danho);
        }
