...
// 7. A partir de las siguientes declaraciones de variables determina el valor de las siguientes expresiones:
...
public static void main(String[] args) {
    ...
    char c = 'c', d = 'd';
     ...
     System.out.println(2 * x + y == 0);
        /* P    System.out.println(2 * x + (y == 0));     Este no se puede ejecutar debido a que estaríamos sumando un valor booleano y uno numérico, lo cual es imposible.*/
     System.out.print("Q: ");
