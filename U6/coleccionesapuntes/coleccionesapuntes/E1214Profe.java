...
public class E1214Profe {
    ...
    /*
     * Dada la clase Temperatura, implementa el método
     * guardarTemperaturas(Collection<Temperatura> cT) que guarde una colección de
     * temperaturas en un fichero binario cuya nombre sigue el siguiente patrón:
     * "registros-yyyyMMdd.dat", siendo "yyyyMMdd" la fecha del día.
     */
