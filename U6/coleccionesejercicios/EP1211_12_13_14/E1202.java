...
public class E1202<T> extends Contenedor<Integer> {
    /*
     * @author Eloy Rodal Pérez
     * E1202. Implementar, con tipos genéricos, la clase Contenedor, donde podremos
     * guardar tantos objetos como deseemos. Para ello utilizaremos una tabla,
     * que inicialmente tendrá tamaño cero y se irá redimensionando según añadamos o
